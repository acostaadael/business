...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8080';
  'jhipster.clientApp.name' = 'business';
  ...
  'jhipster.mail.from' = 'business@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'business API';
  'jhipster.swagger.description' = 'business API documentation';
  ...
  'eureka.instance.appname' = 'business';
  'eureka.instance.instanceId' = 'business:${random.value}';
